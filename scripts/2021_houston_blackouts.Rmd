...
plot_4 <- ggplot() +
  ...
  scale_fill_viridis_c(breaks = c(50000,100000,150000,200000,250000), labels = c("50K", "100K", "150K", "200K", "250K")) +
...
#save figure
ggsave("figures/median_income_blackouts.png", plot_5, width = 8, height = 6, units = "in")
