...
plot_6 <- ggplot(income_distr) +
  ...
  theme(
    ...
    legend.text = element_text(size = 14, hjust = 0.5),
    legend.title = element_text(size = 14, hjust = 0.5, margin = margin(b = 8))
  )
...
plot_7 <- ggplot(income_distr) +
  ...
  scale_x_continuous(labels = scales::label_currency(), expand = c(0, 0), limits = c(0, 265000)) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1.02)) +
  labs(col = "Tract type", x = "Income ($)", y = "Density") +
  scale_color_manual(values = c("#6BB9C7", "#EDB458")) +
  scale_fill_manual(values = c("#6BB9C7", "#EDB458")) +
